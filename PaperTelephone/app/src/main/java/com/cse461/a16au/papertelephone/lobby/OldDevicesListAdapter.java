...
class OldDevicesListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        ((TextView) v.findViewById(android.R.id.text1)).setText((groupPosition == 0 ? "Paired" : "New") + " Devices");
        return v;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        View v = inflater.inflate(android.R.layout.simple_expandable_list_item_1, null);
        ((TextView) v.findViewById(android.R.id.text1)).setText(((List<String>) getGroup(groupPosition)).get(childPosition));
        return v;
    }
