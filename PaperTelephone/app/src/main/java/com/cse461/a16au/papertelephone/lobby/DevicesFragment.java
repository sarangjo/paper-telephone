...
public class DevicesFragment extends Fragment {
  ...
  /**
   * The BroadcastReceiver that listens for discovered devices and changes the title when discovery
   * is finished
   */
  ...
  private ExpandableListView.OnChildClickListener mDeviceClickListener =
  ...
  private void doDiscovery() {
    ...
    ActivityCompat.requestPermissions(
        getActivity(), new String[] {Manifest.permission.ACCESS_COARSE_LOCATION}, 1);
