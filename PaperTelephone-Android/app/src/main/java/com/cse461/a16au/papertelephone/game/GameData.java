...
public class GameData {
   ...
   */
  public ConcurrentMap<String, List<byte[]>> addressToSummaries;
  ...
  void saveData(String creatorAddress, byte[] data) {
    List<byte[]> summary;
